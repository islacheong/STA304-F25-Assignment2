...
ggplot(survey_data, aes(x = age, fill = factor(vote_conservative))) +
  ...
  theme(axis.text.x = element_text(
    ...
    caption = "Figure 2: Proportion of respondents who voted for the Conservative party, by age group")
...
ggplot(survey_data, aes(x = age, fill = factor(vote_ndp))) +
  ...
  theme(axis.text.x = element_text(
    ...
    caption = "Figure 3: Proportion of respondents who voted for the NDP party, by age group")
...
ggplot(census_data, aes(x = age)) +
  ...
  theme(axis.text.x = element_text(
    ...
    caption = "Figure 4: Age Distribution in Census Population")
