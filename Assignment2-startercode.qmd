...
ggplot(survey_data, aes(x = age, fill = factor(vote_liberal))) +
  ...
  labs(title = "Proportion Voting Liberal by Age Group",
       ...
       caption = "Figure 2: Proportion of respondents who voted for the Liberal party") +
  theme_minimal() +
...
ggplot(survey_data, aes(x = age, fill = factor(vote_conservative))) +
  ...
  labs(title = "Proportion Voting Conservative by Age Group",
       ...
       caption = "Figure 3: Proportion of respondents who voted for the Conservative party") +
  theme_minimal() +
  theme(axis.text.x = element_text(
    size = 8,
    angle = 30,
...
ggplot(survey_data, aes(x = age, fill = factor(vote_ndp))) +
  ...
  labs(title = "Proportion Voting NDP by Age Group",
       ...
       caption = "Figure 4: Proportion of respondents who voted for the NDP party") +
  theme_minimal() +
  theme(axis.text.x = element_text(
    size = 8,
    angle = 30,
...
ggplot(census_data, aes(x = age)) +
  ...
  labs(title = "Age Distribution in Census Population", x = "Age Group", y = "Count",
       caption = "Figure 5: Age distributon of 2021 Census respondents") +
  theme_minimal() +
  theme(axis.text.x = element_text(
    size = 8,
    angle = 30,
